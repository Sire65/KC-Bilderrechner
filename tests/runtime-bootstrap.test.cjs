...
assert.match(source,/parserSync/,'Integritäts- und Gateway-Core müssen vor den defer-POS-Skripten verfügbar sein.');
...
console.log('PASS POS runtime bootstrap wires transaction integrity, dual gateway and encrypted local vault from self origin');
