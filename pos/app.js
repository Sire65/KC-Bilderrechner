...
const DEFAULT_PRODUCTS=[
 ...
 {id:"glaszangebundleminus",name:"Glas + Feuerzange Rückgabe",price:-4.00,category:"Pfand",image:"assets/pfand_bundle_placeholder.svg",color:"#9f1239",info:{status:"draft",shortDescription:"Komplettrückgabe von Pfandglas und Feuerzange",important:"Platzhalterbild – Originalfoto wird nachgereicht."}},
...
const REQUIRED_DEPOSIT_RETURNS=[
 {id:"glasminus",name:"Glasrückgabe",price:-2.00,category:"Pfand",image:"assets/pfandglas_auth.jpg",color:"#9f1239"},
 {id:"zangeminus",name:"Feuerzange Rückgabe",price:-2.00,category:"Pfand",image:"assets/feuerzange_placeholder.svg",color:"#9f1239",info:{status:"draft",shortDescription:"Einzelrückgabe Feuerzange",important:"Platzhalterbild – Originalfoto wird nachgereicht."}},
 {id:"glaszangebundleminus",name:"Glas + Feuerzange Rückgabe",price:-4.00,category:"Pfand",image:"assets/pfand_bundle_placeholder.svg",color:"#9f1239",info:{status:"draft",shortDescription:"Komplettrückgabe von Pfandglas und Feuerzange",important:"Platzhalterbild – Originalfoto wird nachgereicht."}}
];
...
if(!GROUPS.some(g=>g.name==="Packages")){GROUPS.push({id:"WG05",name:"Packages",shortName:"Packages",sortOrder:5,color:"#6d28d9",active:true,notes:"Freigegebene Kombi-Angebote"});localStorage.setItem("kc_groups_v050",JSON.stringify(GROUPS))}
...
const DEFAULT_OFFERS=[
 {id:"OFFER-HH-GLUEHWEIN",name:"Happy Hour Glühwein",type:"happyhour",productIds:["grot","gweiss"],priceMode:"percent",priceValue:10,
  startDate:"",endDate:"",startTime:"17:00",endTime:"18:00",weekdays:[1,2,3,4,5,6,0],active:true,manualStart:true,note:"Beispielaktion – in der Konfiguration anpassen."}
];
...
function savePackageFromForm(){
  ...
  savePackages();renderPackageTable();renderCategories();renderProducts();loadPackage(pkg.id);recordAdminChange("package",before?"update":"create",pkg.id,before,pkg);setSystemHint("Package gespeichert");
}
...
async function runTuvSelfTest({show=false}={}){
  ...
  add("version","Versionsstand",VERSION==="V0.31.3.6 Repair 11"?"pass":"fail",`Geladene Version: ${VERSION}`);
