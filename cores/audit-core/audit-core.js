(()=>{
"use strict";
const VERSION="0.2.1",KEY="kc_audit_events_v021";
...
const sanitize=v=>{if(v==null)return v;if(typeof v==="string")return v.slice(0,500);if(Array.isArray(v))return v.slice(0,50).map(sanitize);if(typeof v==="object"){const o={};for(const [k,x] of Object.entries(v)){if(SENSITIVE_KEY.test(k))continue;o[k]=sanitize(x)}return o}return v};
